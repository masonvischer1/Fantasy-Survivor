...
export default function Profile({ session }) {
  ...
  return (
    <div style={{ padding: '1rem', minHeight: '100vh', backgroundImage: `url(${profileBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat' }}>
